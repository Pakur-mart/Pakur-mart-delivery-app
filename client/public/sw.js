const CACHE_NAME = 'pakur-mart-delivery-v2.4';
const STATIC_CACHE = 'static-cache-v2.4';
const DYNAMIC_CACHE = 'dynamic-cache-v2.4';
...
async function storeData(key, data) {
  return new Promise((resolve, reject) => {
    const request = indexedDB.open('PakurDeliveryDB', 1);
